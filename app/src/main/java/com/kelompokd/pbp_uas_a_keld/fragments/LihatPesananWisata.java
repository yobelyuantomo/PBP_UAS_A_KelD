...
import com.kelompokd.pbp_uas_a_keld.adapter.AdapterPesanan;
...
public class LihatPesananWisata extends Fragment {
    ...
    public void setAdapter(){
        ...
        adapter = new AdapterPesanan(view.getContext(), listPesanan, new AdapterPesanan.deleteItemListener() {
            @Override
    ...
    public void getPesanan() {
        ...
        final JsonObjectRequest stringRequest = new JsonObjectRequest(GET, MorentAPI.URL_SELECT_PESANAN + nama
